...
const quizData = [
  {
    ...
    quest: "Помнишь? Мы были в параллельных классах, но близко не общались. В каком классе мы по-настоящему друг друга заметили?",
  ...
  },
  {
    ...
    options: ["Парк в центре города 🌳", "Наш дом - мы работаем дома и это идеально! 💻❤️", "Ресторан 'Белка' где было мое предложение 💍"],
    correct: 1,
  ...
  {
    stage: "СЦЕНА 3: БЕЛКА - МЕСТО ВОЛШЕБСТВА ✨",
  ...
  },
  {
    ...
    options: ["Милый 💕", "Мужко! 😍 (мило же)", "Любимый"],
    correct: 1,
  ...
  {
    stage: "СЦЕНА 8: КОНСИЛЕР-МЕМ 😄💄",
    quest: "Помнишь мем про 8 Марта 2019? Я подарил тебе...",
    options: ["Духи", "КОНСИЛЕР! 😂 И каждый раз ты вспоминаешь этот подарок!", "Помаду"],
    correct: 1,
    photo: "https://via.placeholder.com/400x250/ffc0cb/ffffff?text=CONCEALER+MEME",
    hint: "💭 Каждый раз когда ты хочешь его подарить кому-то, я говорю 'я же покупал!' 😂",
  ...
  {
    stage: "СЦЕНА 12: БОДРУМ - НА ВОЛНЕ ЛЮБВИ 🌊",
    ...
    hint: "💭 Там было красиво... ты была счастлива... и я начал готовить сюрприз ещё тогда 📸",
    reward: "✅ Бодрум - наше волшебное путешествие! 🌊💕"
  },
  {
    stage: "СЦЕНА 13: ПЛЕНОЧНЫЙ ФОТОАППАРАТ 📸",
  ...
  {
    stage: "СЦЕНА 16: АШАН-МЕМ 😂🧻",
    quest: "Помнишь мем про Ашан? Раньше там был отдел животных, а сейчас...",
    options: ["Техника", "ТУАЛЕТНАЯ БУМАГА! 😂 И это стало нашим личным приколом!", "Одежда"],
    correct: 1,
  ...
  {
    stage: "СЦЕНА 18: ДОМАШНИЕ РАСТЕНИЯ 🌱",
  ...
  {
    stage: "СЦЕНА 19: ФРЕНДЗОНА - НАША ПЕСНЯ 🎵",
