    ...
    <div className="love-app">
      ...
      <div className="final-screen">
        ...
        <div className="final-message">
          Я люблю тебя, моя жИнка. Ты моё счастье и радость в этом мире. Я очень рад, что ты у меня есть. Благодаря тебе я мотивирую себя на всё. Я очень надеюсь, что у нас всё будет хорошо и мы добьемся всего. Будь всегда счастливой, оптимистичной - ты отличный компаньон! У тебя будет миллион подружек, миллион счастливых моментов. А я всегда тебя во всём поддержу. 💕✨
        </div>
